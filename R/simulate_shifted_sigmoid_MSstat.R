simulate_shifted_sigmoid_MSstat = function(n=4,error_sd=0.05,subject_sd=0,half_temp_grid=FALSE){
  ...
  sample_idx = sample(1:nrow(truepositive_sample_sigmoid_posterior_df_MSstats),1)
  sample_params = truepositive_sample_sigmoid_posterior_df_MSstats[sample_idx,] #get posterior params
