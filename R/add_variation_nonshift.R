add_variation_nonshift<-function(template,icc,n_conditions,n_replicates,re_var,t_range,design="TPP"){
  ...
  input<-matrix(nrow=10,ncol=2)
  input[,1]<-template$Abundance
  input[,2]<-template$Abundance
