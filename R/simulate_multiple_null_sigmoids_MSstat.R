...
simulate_multiple_null_sigmoids_MSstat = function(runs=1000,n=4,error_sd=0.05,subject_sd=0,half_temp_grid=FALSE){
  ...
  for(i in 1:runs){
    ...
    sim = simulate_null_sigmoid_MSstat(n=n,error_sd=error_sd,subject_sd = subject_sd,half_temp_grid=half_temp_grid)
