...
#workingDirectory<- "~/work/ivanovlab/figueroa-navedo.a/data/Human"
...
```{r}
targets<-MSstatsproteins|>as.data.frame()|>dplyr::filter(Protein%in% c("P36507","Q02750"))|>dplyr::mutate(Accession=Protein)|>dplyr::inner_join(Stat_mod)|>dplyr::group_by(Accession)|>dplyr::group_split()
...
```
#Reproduce manuscript figures (sample files will not work with this)
