...
```{r}
OnePot_1plex_5repsnon<-benchmark_shifter_sim_1plex(Dataset_2_ICC,templateProtein="Q6NV46",n_sims=1000,t_range=seq(5,6),design="OnePot")
...
###Print out ICC distributions and simulate a strong shifter
...
```{r}
OnePot_1plex_2repsnon<-benchmark_shifter_sim_1plex(Dataset_2_ICC,templateProtein="Q6NV46",n_sims=1000,t_range=seq(5,6),design="OnePot")
