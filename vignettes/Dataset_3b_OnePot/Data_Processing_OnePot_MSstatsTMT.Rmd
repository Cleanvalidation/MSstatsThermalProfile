...
# Compare DMSO vs all concentrations on avg
...
## Get Kinase compiled from Xu *et. al.*
...
```
#Compare MSstatsTMT statistical modeling with full curves using MSstatsTMT at the Protein and PSM level
```{r}
...
dev.off() 
```
#Compare MSstatsTMT statistical modeling with OnePot using MSstatsTMT at the Protein and PSM level
```{r}
