...
---
#With dataset 3b, this vignette will outline OnePot processed datasets at the protein level and evaluate MSstatsTMT statistical modeling.
...
#D. GroupComparisonTMT DMSO OnePot vs 25x
...
```
#F. Figure 4, panel A,  Read in TPP processed PD results with TPP statistical models to compare against OnePot
...
#F. Figure 4, panel B: Read in TPP processed PD results with NPARC statistical models to compare against OnePot
...
#G. Figure 4 panel C, Read in TPP processed PD results with SCAM statistical models to compare against OnePot
...
#H. Figure 8, panel D: Read in TPP processed PD results with MSstatsTMT statistical models to compare against OnePot
